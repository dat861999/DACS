...
<body>
    ...
    <div class="list-services-page__header" style="background-image: url(img/bg-img/bkav.jpg);height: 300px;">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="page-title text-center">
                        <h2 style="background:cornsilk;color: blue;height: 100px;font-size: 70px;">Thông Tin Triệu Chứng</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    if  (isset($_REQUEST['search'])){
        ...
        if ($result = $mysqli->query($query)) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if(strpos($row['TrieuTrung'],$info)!== false)
                    {
                        // echo 'Khoa' . $i ;
                        // echo $row['TenKhoa'];
                        // echo '<br>';
                        ...
                        // $pieces = explode('indam',$row['TrieuTrung']);
 ...
 <div class="col-12 col-lg-6">
                    <div class="single-blog-area mb-50">
                        ...
                        <div class="hover-content">
                            ...
                            <p><?php echo substr($row['TrieuTrung'],0,200) .'.  .  .  .' ; ?></p>
                            <a href=<?php echo 'ChiTietKhoa.php'.'?id='.$row['ID'] ?>>Tìm Hiểu Thêm <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
 ...
 <div>
 <mark>
    <h2 style="text-align: center;background-color: #33ccff;"> Triệu Trứng Tham khảo</h2>
</mark>
    </div> 
    <div class="blog-wrapper section-padding-80">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="single_widget_area d-flex mb-30">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="shop.php"><p style="font-size: 20px;color: gainsboro;"> YourDoctor </p></a></li>
                                <li><a href="blog.php"><p style="font-size: 20px;color: gainsboro;"> Hỏi Đáp </p></a></li>
                                <li><a href="contact.php"><p style="font-size: 20px;color: gainsboro;"> Liên Hệ </p></a></li>
                ...
                <div class="col-12 col-md-6">
                    <div class="single_widget_area mb-30">
                        ...
                        <a href="DichVu.php"><p style="font-size: 20px;color: gainsboro;"> Tra Cứu Triệu Chứng <img src="img/core-img/TimKiem.png"width="30px" alt=""></p></a>
                        ...
                        <a href="DichVu.php"><p style="font-size: 20px;color: gainsboro;">Đặt Câu hỏi Với Bác Sĩ                            <img src="img/core-img/QSA.png"width="30px" alt=""></p></a>
